CREATE VIEW [dbo].[V_LG_BR_FR_SANS_FACT]
AS
SELECT DISTINCT 
                      ...
                      dbo.ARTICLE.DESIGNATION_ARTICLE, dbo.ARTICLE.DESCRIPTION_ARTICLE, dbo.LG_BR_FR.QTE_LG_BR_FR -
                          (SELECT     ISNULL(SUM(QTE), 0) AS Expr1
                            ...
                            WHERE      (CODE_BR_FR = dbo.LG_BR_FR.CODE_BRECEP) AND (CODE_ARTICLE = dbo.LG_BR_FR.CODE_ARTICLE)) AS Expr1, dbo.LG_BR_FR.UNITE, 
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_LG_BR_FR_SANS_FACT';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_LG_BR_FR_SANS_FACT';
